...
C-----------------------------------------------------------------------
      ...
      SIG = 0.07155239813179404D0 + 0.06606791761347486D0*P0 - 
     -  0.00024112533580554287D0*P0**2 + 
     -  1.143510757936114D-6*P0**3 - 
     -  2.2910564964032D-9*P0**4 + 2.2151475945322894D-12*P0**5 - 
     -  8.284546815733482D-16*P0**6
      ...
      IMPLICIT DOUBLE PRECISION (A-H,K-Z)
       ...
       IF ( P0 .GT. 50.D0 ) THEN
     	...
     	FED= 257.9799384090066D0 + 1.9569165063025655D0*P0
   
      ELSE IF ( P0 .GT.  0.5658D0 .AND. P0 .LE. 50.D0 ) THEN
 
       FED=         26.792963384820982D0 + 212.32723839848072D0*P0 - 
     -  183.05922154778605D0*P0**2 + 
     -  89.85873533958548D0*P0**3 - 26.782581281061287D0*P0**4 + 
     -  5.234534531022756D0*P0**5 - 0.7079405866302086D0*P0**6 + 
     -  0.0687440360332156D0*P0**7 - 0.004913868423197951D0*P0**8 + 
     -  0.00026269453845358007D0*P0**9 - 
     -  0.000010590337777766127D0*P0**10 + 
     -  3.2231720681360846D-7*P0**11 - 
     -  7.356748971512561D-9*P0**12 + 
     -  1.2387524537448806D-10*P0**13 - 
     -  1.4920818654276785D-12*P0**14 + 
     -  1.2156733044662518D-14*P0**15 - 
     -  5.999956952734376D-17*P0**16 + 
     -  1.3542143049639314D-19*P0**17
        
       ELSE IF (P0 .GT. 4.99313436D-4 .AND. P0 .LE. 0.5658D0) THEN
   

       FED= 1.9556157223144337D0 + 510.1571753657856D0*P0 - 
     -  1731.0073225480944D0*P0**2 + 
     -  2942.342342591839D0*P0**3 - 1842.4124908739573D0*P0**4
