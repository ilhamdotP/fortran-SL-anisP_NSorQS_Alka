...
C------------------------------------------------------------------------------
     ...
     &     -4.D0*BETA*KFO**(5.D0)/(5.D0*PI*PI)
      ...
      OPEN(unit=1,status='unknown',file='BE_SNM_BSP30.dat')
...
c         KNCM= 9.0D0*RHBO*RHBO*func2(RHBO)
c         KJN0= 27.0D0*RHBO*RHBO*RHBO*func3(RHBO)
C    
c         SYME= ASIM(RHBO)
c         LSY= 3.0D0*RHBO*lsym(RHBO)
c         KSY= 9.0D0*RHBO*RHBO*ksym(RHBO)
...
C     ****************************************************
       ...
       WRITE(1,*)RHBO,(RB/(HC*HC*HC)),EB,PRESS
