      PROGRAM SNM        
c     ****************************************************
c     verified 24 Juli 2021 check "new analitic pressure"
c     ****************************************************
...
c      RHO = 2D0*KFO*KFO*KFO/(3D0*PI*PI)
      ...
      write(filename,frmt)"EOS_FSU2HZ2_GUP", BETA, ".dat"
      write(*,*)filename
...
C-----------------------------------------------------------------------------
      ...
      DRHO = -4D0*KFO*KFO*KFO*KFO*KFO/(5D0*PI*PI)
      RHO = RHO + BETA*DRHO   
...
c-----------------------------------------------------      
      ...
      DPP = (105.*KFP*MP**6+65.*KFP**3*MP**4-26.*KFP**5*MP**2
     .     +56.*KFP**7)/DSQRT((KFP*KFP)+(MP*MP))
      DPP = DPP-105*MP**6*TEMP2
      ...
      DPN = (105.*KFN*MN**6+65.*KFN**3*MN**4-26.*KFN**5*MN**2
     .     +56.*KFN**7)/DSQRT((KFN*KFN)+(MN*MN))
      DPN = DPN-105*MN**6*TEMN2
      ...
      DPE = (105.*KFE*ME**6+65.*KFE**3*ME**4-26.*KFE**5*ME**2
     .     +56.*KFE**7)/DSQRT((KFE*KFE)+(ME*ME))
      DPE = DPE-105*ME**6*TEME2
      ...
      DPM = (105.*KFM*MO**6+65.*KFM**3*MO**4-26.*KFM**5*MO**2
     .     +56.*KFM**7)/DSQRT((KFM*KFM)+(MO*MO))
      DPM = DPM-105*MO**6*TEMM2
